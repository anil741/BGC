...
##parent-placeholder-040f06fd774092478d450774f5ba30c5da78acc8##
                ...
                <div class="col-md-12">               
                    <div class="card card-primary card-outline shadow mt-3">
                        <div class="car-header p-3">
                            <div class="card-title font-weight-bold text-center"> <?php echo e((isset($data['Action']) && $data['Action'] != "") ? "Update Organisation": "New Organisation"); ?> </div>
                        </div>                
                                    ...
                                    <div>                     
                                        <div class="form-group row">                              
                                            ...
                                            <div class="col-sm-4">   
                                                ...
                                                <input type="text" class="form-control mb-2" title="Only alphanumeric and space are allowed." pattern="[a-zA-Z0-9 ]+" id="org_name" name="organisation_name" value="<?php echo e(($data['orgData'][0]->organisation_name != "") ? $data['orgData'][0]->organisation_name :  old('organisation_name')); ?>" placeholder="Enter Organisation Name *" required>
                                            ...
                                            <div class="col-sm-4">    
                                                ...
                                                pattern="^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$" id="org_email" name="email_address" value="<?php echo e(($data['orgData'][0]->email_address != "") ? $data['orgData'][0]->email_address : old('email_address')); ?>" placeholder="Enter Business Email *"  readonly required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">      
                                                ...
                                                <input type="text" class="form-control mb-2" id="org_phone" name="contact" value="<?php echo e((Session::get('formerror_org') == "") ? $data['orgData'][0]->contact : old('contact')); ?>" placeholder="Enter Phone Number *"  readonly>
                                            ...
                                            <div class="col-sm-4">    
                                                ...
                                                <input type="text" class="form-control" id="org_address" name="address" value="<?php echo e(($data['orgData'][0]->address != "") ? $data['orgData'][0]->address : old('address')); ?>" placeholder="Enter Address *" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">   
                                                ...
                                                <input type="text" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" class="form-control mb-2" id="org_city" name="city" value="<?php echo e(($data['orgData'][0]->city != "") ? $data['orgData'][0]->city : old('city')); ?>" placeholder="Enter City Name *" required>
                                            ...
                                            <div class="col-sm-4"> 
                                              <label for="pincode">Pincode</label>                         
                                                <input type="text" class="form-control mb-2" id="org_pincode" title="Only alphanumeric and space are allowed." pattern="[a-zA-Z0-9 ]+" name="pincode" value="<?php echo e(($data['orgData'][0]->pincode != "") ? $data['orgData'][0]->pincode : old('pincode')); ?>" placeholder="Enter Pincode Number *" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">   
                                              ...
                                              <input type="text" class="form-control mb-2" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" id="org_State" name="state" value="<?php echo e(($data['orgData'][0]->state != "") ? $data['orgData'][0]->state : old('state')); ?>" placeholder="Enter State / Province *" required>
                                            ...
                                            <div class="col-sm-4">    
                                              ...
                                              <input type="text" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" class="form-control mb-2" id="org_country" name="country" value="<?php echo e(($data['orgData'][0]->country != "") ? $data['orgData'][0]->country : old('country')); ?>" placeholder="Enter Country Name *" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">  
                                                <button type="submit" id="submitbtn" class="btn update_btn btn-primary mb-3 btn-block">Update</button>
                                            </div>
                                            <div class="col-sm-4"></div>
                                        </div>
                                    </div>  
    ...
    <?php else: ?>
        <div class="content">
            <form method="post" id='saveOrg' autocomplete="off" action="<?php echo e(Route('saveOrganisation')); ?>" enctype="multipart/form-data"> 
                <?php echo csrf_field(); ?>
                <div class="content">
                    <div class="row">           
                        <div class="col-md-12">               
                                    ...
                                    <div class="mb-3">  
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="col-sm-4">  
                                              ...
                                              <input type="tel" tabindex="4" class="form-control" placeholder="Enter Phone *" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode &gt;= 48 && event.charCode &lt;= 57" value="<?php echo e(old('contact')); ?>" id="org_contact" name="contact" required />
...
<?php echo $__env->make('backend.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/app1/html/BGC/resources/views/backend/organisation_add.blade.php ENDPATH**/ ?>