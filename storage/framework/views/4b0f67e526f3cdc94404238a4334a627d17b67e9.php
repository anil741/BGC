        ...
        <div class="col-md-12">               
            <div class="card card-primary card-outline shadow mt-3">
                <div class="car-header p-3">
                    <div class="card-title font-weight-bold text-center"> Cancelled Order List </div>
                            ...
                            <?php if(isset($data['application']) && $data['application'] != "" ): ?>
                                <?php $__currentLoopData = $data['application']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                    <tr>
                                        ...
                                        <?php $appStatus = ""; 
                                            if($details['application_status_id'] == 5){
                                                $appStatus = '<small class = "label text-danger"> <b>Application Rejected</b> </small>'; 
                                            }
                                        ?>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-">
                                                <div class="row">  
                                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg">
                                                        <a class="btn btn-primary btn-xs" title="View Details" href="<?php echo e(Route('allFormfilledDetailsViewRejected',['candidate_id'=> $details['id'] ])); ?>"><i class="fa fa-eye"></i> </a>
...
<?php echo $__env->make('backend.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/app1/html/BGC/resources/views/backend/rejected_application_list.blade.php ENDPATH**/ ?>