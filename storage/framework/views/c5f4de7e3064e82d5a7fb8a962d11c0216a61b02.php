                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control mb-2" id="org_city" name="city"
                                                value="<?php echo e($data['orgDetails'][0]->no_of_employees); ?>" placeholder="Enter Number of Employees *"
                                                readonly>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control mb-2" id="org_contact" name="contact"
                                                value="<?php echo e($data['orgDetails'][0]->contact); ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control mb-2" name="apt"
                                                value="<?php echo e($data['orgConsentDetails'][0]->apt); ?>"
                                                placeholder="Enter Apt/Unit # *" readonly>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control mb-2" name="city"
                                                value="<?php echo e($data['orgConsentDetails'][0]->city); ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="email" class="form-control mb-2" name="email"
                                                value="<?php echo e($data['orgConsentDetails'][0]->email); ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control mb-2" name="title"
                                                value="<?php echo e($data['orgConsentDetails'][0]->title); ?>"
                                        ...
                                        <div class="col-sm-4"></div>
                                         <div class="col-sm-4">
                                             <form method="post" id='verify' action="<?php echo e(Route('verifyOrganisation')); ?>"
                                                 ...
                                                 <input type="hidden" name="org_name" value="<?php echo e($data['orgDetails'][0]->organisation_name); ?>">
                                                 <input type="hidden" name="email" value="<?php echo e($data['orgDetails'][0]->email_address); ?>">
...
<?php echo $__env->make('backend.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/app1/html/BGC/resources/views/backend/organisation_details.blade.php ENDPATH**/ ?>