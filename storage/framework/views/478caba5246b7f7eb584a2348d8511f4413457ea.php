        ...
        <div class="col-md-12">               
            <div class="card card-primary card-outline shadow mt-3">
                <div class="car-header p-3">
                    <div class="card-title font-weight-bold text-center"> Role </div>
                    <div class="float-right">  
                        <a class="btn btn-sm btn-primary" href="<?php echo e(Route('addRoleView')); ?>"><i class="fa fa-plus"></i> Add </a>
                    </div> 
                </div>                
                <div class="card-body">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#role').change(function(){    
            ...
            $.ajax({
                type:'GET',
                url:"<?php echo e(Route('getRoleCategotyAndPermissions')); ?>",
...
<?php echo $__env->make('backend.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/app1/html/BGC/resources/views/backend/roles_and_permission.blade.php ENDPATH**/ ?>