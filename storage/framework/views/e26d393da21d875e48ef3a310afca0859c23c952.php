...
<?php $__env->stopSection(); ?>
<?php echo $__env->make( (session('role_category') == 4)? 'backend.layout.org_header': ( (session('role_category') != 4) ? 'backend.layout.header' : 'backend.layout.header') , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\BGC\resources\views/backend/profileView.blade.php ENDPATH**/ ?>