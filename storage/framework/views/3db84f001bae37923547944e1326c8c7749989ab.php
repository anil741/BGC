                ...
                <div class="invoice p-3 mb-3">
                  ...
                  <?php else: ?>
                    ...
                    <div class="row invoice-info">
                      ...
                      <div class="col-sm-4 invoice-col">  
                      <label class="form-label" for="customFile"><b>Service Document</b></label>                         
                        <input type="file" class="form-control" id="service-file" onchange="confirmUpload(<?php echo $data['candidate_id']; ?>)" />
                      </div>
                      <!-- /.col -->
                                ...
                                <?php if(isset($data['services']) && $data['services'] != "" ): ?>
                                    ...
                                    <?php $__currentLoopData = $data['services']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><i class="fa fa-pen" data-toggle="modal" data-target="#notes-edit-<?php echo e($service->id); ?>" style="cursor: pointer;float: left;"></i><?php echo e($service->notes); ?></td>  
                                            <td style="text-align: right;">
                                            <i class="fa fa-pen" data-toggle="modal" data-target="#status-edit-<?php echo e($service->id); ?>" style="cursor: pointer;float: left;"></i>
                                          ...
                                          <div class="modal-dialog">
                                            ...
                                            <div class="modal-header">
                                              ...
                                              <div class="modal-body">
                                                <h3>Notes</h3>
                                                <textarea id="notes-<?php echo e($service->id); ?>" name="notes" rows="4" cols="60"><?php echo e($service->notes); ?></textarea>
                                              </div>
                                            ...
                                            <div class="modal-header">
                                              ...
                                              <div class="modal-body">
                                                ...
                                                <select class="form-control" id="status-<?php echo e($service->id); ?>" name="status">
                                                  <option value="1" <?php echo e($service->status == 1 ? 'selected' : ''); ?>>In Progress</option>
                                                  <option value="2" <?php echo e($service->status == 2 ? 'selected' : ''); ?>>Completed</option>
                                                  <option value="3" <?php echo e($service->status == 3 ? 'selected' : ''); ?>>Incomplete</option>
                                                  <option value="4" <?php echo e($service->status == 4 ? 'selected' : ''); ?>>Missing Information</option>
                                                  <option value="5" <?php echo e($service->status == 5 ? 'selected' : ''); ?>>Not Applicable</option>
                                                  <option value="6" <?php echo e($service->status == 6 ? 'selected' : ''); ?>>Discrepancy</option>
                                                  <option value="7" <?php echo e($service->status == 7 ? 'selected' : ''); ?>>Cancelled</option>
                                                </select>
...
<div class="content">
  <div class="row">           
    <div class="col-md-12">               
      <div class="card card-primary card-outline shadow mt-3">
        <div class="car-header p-3">
          <div class="card-title font-weight-bold text-center"> Order Status Update </div>
        </div> 
        <div class="card-body">                                               
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/BGC/resources/views/backend/op_application_details_view.blade.php ENDPATH**/ ?>