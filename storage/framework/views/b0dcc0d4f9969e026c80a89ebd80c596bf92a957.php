                            ...
                            <div>  
                                ...
                                <div class="form-group row">                               
                                    ...
                                    <div class="col-sm-6">     
                                        ...
                                        <input type="text" class="form-control mb-2" onkeypress="return lettersOnly(event)" name="father_name" value="<?php echo e(old('father_name')); ?>" placeholder="Enter Father's Name">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">   
                                        <label for="" class="required">Gender</label>   <br>                                    
                                    ...
                                    <div class="col-sm-6">      
                                        <label for="">SIN</label>                              
                                        <input type="text" class="form-control mb-2" name="SIN" value="<?php echo e(old('SIN')); ?>" placeholder="Enter SIN" pattern="\d{9}" title="9 digits are required." onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode &gt;= 48 && event.charCode &lt;= 57" maxlength="9">
                                ...
                                <div class="form-group row">                               
                                    <div class="col-sm-6">      
                                        <label for="" class="required">Home Number</label>                                   
                                    ...
                                    <div class="col-sm-6">        
                                        <label for="" class="required">Driver License</label>                             
...
<?php echo $__env->make('backend.layout.org_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\BGC\resources\views/backend/forms/personal_details_form.blade.php ENDPATH**/ ?>