    ...
    <div class="login-box">
      ...
      <div class="card card-outline card-primary">
        ...
        <p class="mb-0 mt-3 text-center">
          <a  href="<?php echo e(url('/signup')); ?>" class="text-center text_color"><b>Become our Client</b></a>
        </p>
    </div>
  <!-- </div> -->
</section>
...
<?php echo $__env->make('frontend.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\BGC\resources\views/frontend/login.blade.php ENDPATH**/ ?>