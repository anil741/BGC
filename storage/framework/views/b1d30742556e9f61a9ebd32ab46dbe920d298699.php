        ...
        <div class="col-md-12">               
            <div class="card card-primary card-outline shadow mt-3">
                <div class="car-header p-3">
                    <div class="card-title font-weight-bold text-center"> Completed Order List </div>
                            ...
                            <?php if(isset($data['application']) && $data['application'] != "" ): ?>
                                <?php $__currentLoopData = $data['application']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                    <tr>
                                        ...
                                        <?php if($details['application_status_id'] == 6){
                                            $appStatus = '<small class = "label text-success"> <b>Application Verified</b> </small>'; 
                                            }
                                        ?>
                                        ...
                                        <td><?php echo e($details['remark']); ?></td> 
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-">
                                                <div class="row">  
                                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg">
                                                        <a class="btn btn-primary btn-xs" title="View Details" href="<?php echo e(Route('allFormfilledDetailsViewCompleted',['candidate_id'=> $details['id'] ])); ?>"><i class="fa fa-eye"></i> </a>

                                                        <a class="btn btn-primary btn-xs" title="View Details" href="<?php echo e(Route('opcandidateApplicationDetailsReadOnlyView',['candidate_id'=> $details['id'] ])); ?>"><i class="fa fa-tasks"></i> </a>
                                                    </div>                                                     
...
<?php echo $__env->make('backend.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/BGC/resources/views/backend/op_completed_application_list.blade.php ENDPATH**/ ?>