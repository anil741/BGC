    ...
    function search()
    {
        ...
        $.ajax({
            headers: {
                ...
                url: '<?php echo e(Route('searchReset')); ?>',
                type: 'post',
                dataType: 'json',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/app1/html/BGC/resources/views/backend/searchRequest.blade.php ENDPATH**/ ?>