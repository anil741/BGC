        ...
        <div class="col-md-12">               
            <div class="card card-primary card-outline shadow mt-3">
                <div class="car-header p-3">
                    ...
                    <div class="card-title font-weight-bold text-center"> Update User </div>
                    <?php else: ?>
                    <div class="card-title font-weight-bold text-center"> Add New User</div>
                    <?php endif; ?>
                    ...
                    <div class="card-body">                        
                            <?php if(isset($data['Action']) && $data['Action'] == "Edit"): ?>     
                                <form method="post" id='userUpdate' action="<?php echo e(Route('orgUpdateUser')); ?>" enctype="multipart/form-data">                         
                                    <?php echo csrf_field(); ?>                       
                                    <?php if(isset($data['UserDetails']) && $data['UserDetails'] != ""): ?>
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <select id="role" name="role" class="form-control" required>
                                                    <?php $__currentLoopData = $data['roles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php
                                                            $roleSelected = ($role->id == $data['UserDetails'][0]->roleId) ? 'selected' : '';
                                                        ?>
                                                        <option value="<?php echo e($role->id); ?>" <?php echo e($roleSelected); ?>><?php echo e($role->name); ?></option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="tel" class="form-control" id="Phone" name="Phone" value="<?php echo e(( !empty(old('Phone')) && old('Phone') != "") ? old('Phone') : $data['UserDetails'][0]->mobno); ?>" placeholder="Enter Phone *" readonly/>

                                                
                                                <br>
                                                <?php if($errors->has('Phone')): ?>
                                                <br><span class="text-danger"><?php echo e($errors->first('Phone')); ?></span>
                                                <?php endif; ?>
                                                <?php if(Session::has('formerror')): ?>
                                                <br><span class="text-danger"> <?php echo e(Session::get('formerror')); ?></span>
                                                <?php endif; ?> 
                                            </div>  
                                            <div class="col-sm-2"></div>                         
                                        </div> 
                            ...
                            <?php else: ?>    
                                <form method="post" id='assignUserRole' action="<?php echo e(Route('orgUserSave')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>                        
                                    <div class="form-group row">
                                        <div class="col-sm-2"></div>
                                        <div class="col-sm-8">                                        
                                        ...
                                        <select id="role" name="role" class="form-control" required>
                                            <?php $__currentLoopData = $data['roles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($role->id); ?>" <?php echo e($key == 0 ? 'selected' : ''); ?>><?php echo e($role->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php else: ?> 
                                            <div class="alert alert-danger">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">    
                                            ...
                                            <input type="tel" tabindex="4" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode &gt;= 48 && event.charCode &lt;= 57" class="form-control" placeholder="Enter Phone *" id="phone" value="<?php echo e(old('Phone')); ?>" name="contact" required />
...
<?php echo $__env->make('backend.layout.org_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/BGC/resources/views/backend/organisation/org_add_user.blade.php ENDPATH**/ ?>