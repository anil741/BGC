                            ...
                            <?php if(isset($data['application']) && $data['application'] != "" ): ?>
                                <?php $__currentLoopData = $data['application']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                    <tr>
                                        ...
                                        <?php if($details['application_status_id'] == 3){
                                        ...
                                        <td>
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-">
                                                <div class="row">  
                                                    ...
                                                    <a class="btn btn-primary btn-xs" title="Accept" href="<?php echo e(Route('acceptApplicationByUser',['application_id'=> $details['application_id'] ])); ?>">Accept</a>
                                                    </div>
...
<?php echo $__env->make('backend.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/BGC/resources/views/backend/op_pending_application_list.blade.php ENDPATH**/ ?>