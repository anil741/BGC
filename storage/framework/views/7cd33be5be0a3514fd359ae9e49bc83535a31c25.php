                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-">
                                                        <?php if($details['is_orgVerified'] == 1 && $details['is_orgVerified'] == 1 ): ?>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <form role="form" method='post' action='<?php echo e(Route('editOrgUserView')); ?>' class="col-sm-12 col-md-12">
...
<?php echo $__env->make('backend.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/app1/html/BGC/resources/views/backend/organisation_users_list.blade.php ENDPATH**/ ?>