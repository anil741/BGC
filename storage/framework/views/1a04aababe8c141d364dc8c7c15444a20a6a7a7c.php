...
<div class="content">
<form method="post" id='saveOrg' autocomplete="off" action="<?php echo e(Route('employmentVerificationSave')); ?>" enctype="multipart/form-data"> 
    <?php echo csrf_field(); ?>
    <div class="content">
        <div class="row">           
            <div class="col-md-12">               
                    ...
                    <div class="card-body m-3">                                            
                        <div> 
                            <div class="form-group row text-center"> 
                                ...
                                <div class="col-sm-12">                                  
                                    <label for="">EMPLOYMENT DETAILS (As per resume)</label>
                                 </div>                                 
                                ...
                                <div class="form-group row mt-5"> 
                                    ...
                                    <div class="col-sm-10" style="border: 1px solid #dee2e6; padding:15px;">
                                        ...
                                        <div class="form-group row mt-4">
                                            ...
                                            <input type="text" class="form-control mb-2" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" name="employer_name[<?php echo e($i); ?>]" value="<?php echo e(isset($details['personalDetails'][$i-1]->employer_name) ? $details['personalDetails'][$i-1]->employer_name : ""); ?>" placeholder="Enter Employer Name *" required>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control mb-2" onkeypress="return lettersOnly(event)" name="first_name[<?php echo e($i); ?>]" value="<?php echo e(isset($details['personalDetails'][$i-1]->first_name) ? $details['personalDetails'][$i-1]->first_name : ""); ?>" placeholder="Enter First Name *" required>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control mb-2" onkeypress="return lettersOnly(event)" name="middle_name[<?php echo e($i); ?>]" value="<?php echo e(isset($details['personalDetails'][$i-1]->middle_name) ? $details['personalDetails'][$i-1]->middle_name : ""); ?>" placeholder="Enter Middle Name">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control mb-2" onkeypress="return lettersOnly(event)" name="last_name[<?php echo e($i); ?>]" value="<?php echo e(isset($details['personalDetails'][$i-1]->last_name) ? $details['personalDetails'][$i-1]->last_name : ""); ?>" placeholder="Enter Last Name *" required>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                <label>Email</label> 
                                                <input type="email" class="form-control mb-2" title="Contact's email (format: xxx@xxx.xxx)" pattern="^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$" name="email[<?php echo e($i); ?>]" value="<?php echo e(isset($details['personalDetails'][$i-1]->email) ? $details['personalDetails'][$i-1]->email : ""); ?>" placeholder="Enter Contact E-mail (Official) *" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control mb-2" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" name="department[<?php echo e($i); ?>]" value="<?php echo e(isset($details['personalDetails'][$i-1]->department) ? $details['personalDetails'][$i-1]->department : ""); ?>" placeholder="Enter Designation & Department (Ex.HR/Owner): *" required>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control mb-2" name="employee_id[<?php echo e($i); ?>]" value="<?php echo e(isset($details['personalDetails'][$i-1]->employee_id) ? $details['personalDetails'][$i-1]->employee_id : ""); ?>" placeholder="Enter Employee ID *" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control mb-2" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" name="job_title[<?php echo e($i); ?>]" value="<?php echo e(isset($details['personalDetails'][$i-1]->job_title) ? $details['personalDetails'][$i-1]->job_title : ""); ?>" placeholder="Enter Job Title *" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="text" class="form-control mb-2" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" name="reason_for_leaving[<?php echo e($i); ?>]" value="<?php echo e(isset($details['personalDetails'][$i-1]->reason_for_leaving) ? $details['personalDetails'][$i-1]->reason_for_leaving : ""); ?>" placeholder="Enter Reason for Leaving *" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <input type="text" class="form-control mb-2" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" name="employment_type[<?php echo e($i); ?>]" value="<?php echo e(isset($details['personalDetails'][$i-1]->employment_type) ? $details['personalDetails'][$i-1]->employment_type : ""); ?>" placeholder="Enter Employment Type *" required>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group date from_date" id="from_date<?php echo e($i); ?>" data-target-input="nearest">
                                                    <input type="text" placeholder="From (yyyy/mm/dd) *" class="form-control datetimepicker-input" name="from_date[<?php echo e($i); ?>]" value="<?php echo e(isset($details['personalDetails'][$i-1]->from_date) ? $details['personalDetails'][$i-1]->from_date : ""); ?>" data-target="#from_date<?php echo e($i); ?>" required/>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group date to_date" id="to_date<?php echo e($i); ?>" data-target-input="nearest">
                                                    <input type="text" placeholder="To (yyyy/mm/dd) *" class="form-control datetimepicker-input" name="to_date[<?php echo e($i); ?>]" value="<?php echo e(isset($details['personalDetails'][$i-1]->to_date) ? $details['personalDetails'][$i-1]->to_date : ""); ?>" data-target="#to_date<?php echo e($i); ?>" required/>
                            ...
                            <?php if(isset($details['personalDetails']) && $details['personalDetails'] != "" ): ?>
...
<?php echo $__env->make('backend.layout.candidate_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/BGC/resources/views/frontend/forms/employment_verification_form.blade.php ENDPATH**/ ?>