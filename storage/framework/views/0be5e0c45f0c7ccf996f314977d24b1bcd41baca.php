                                ...
                                <div class="form-group row"> 
                                    ...
                                    <div class="col-sm-8" style="border: 1px solid #dee2e6; padding:15px;">
                                        <div class="form-group row mt-4">
                                            <label class="required">Enter Highest Education <?php echo e($i); ?> :</label> 
                                        ...
                                        <div class="form-group row">
                                            <label class="required">Enter Institution Name and Full Address</label> 
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                            <label class="required">Enter Degree Obtained</label> 
                                            ...
                                            <div class="col-md-6">
                                                <label class="required">Enter Enrollment/Registration</label> 
                                       ...
                                       <div class="form-group row">
                                            <div class="col-md-6">
                                            <label class="required">Select Degree start date</label> 
                                            ...
                                            <div class="col-md-6">
                                                <label class="required">Select Graduated date</label> 
...
<?php echo $__env->make('backend.layout.org_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\BGC\resources\views/backend/forms/education_verification_form.blade.php ENDPATH**/ ?>