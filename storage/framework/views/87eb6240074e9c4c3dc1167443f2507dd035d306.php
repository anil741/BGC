                        ...
                        <input type="hidden" name="package" value="<?php echo e($package); ?>" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <ul>
                                        <li>Please provide all the requested information from your previous employer.</li>
                                        <li>Add employer to be chosen to provide more employer details.</li>
                                        <li>Supporting documents (Relieving/Experience Letter, Employment letter) mentioning your employment details are to be submitted during submission.</li>
                                ...
                                <div class="form-group row mt-5"> 
                                    ...
                                    <div class="col-sm-10" style="border: 1px solid #dee2e6; padding:15px;">
                                        ...
                                        <div class="form-group row mt-4">
                                            <label class="required">Enter Employer Name</label> 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <label class="required">Designation & Department</label> 
                                        ...
                                        <div class="form-group row">
                                            <label class="required">Employment Type (Permanent/Contract):<br><span style="font-weight: 400;"> If Contract, Please mention the agency name.</span> </label>
                                         ...
                                         <div class="form-group row">
                                            <label class="col-md-12 required">Employment Duration (yyyy/mm/dd):</label> 
                                            <div class="col-md-6">
...
<?php echo $__env->make('backend.layout.org_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\BGC\resources\views/backend/forms/employment_verification_form.blade.php ENDPATH**/ ?>