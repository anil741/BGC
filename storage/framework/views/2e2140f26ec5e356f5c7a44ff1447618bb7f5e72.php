                ...
                <div class="card-body">                
                	...
                	<form method="post" id='assignUserRole' action="<?php echo e(Route('applicantDetails')); ?>" enctype="multipart/form-data">
	                    ...
	                    <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select id="package" name="package" class=" form-control col-md-12" onchange="get_services()" required=""> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layout.org_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/app1/html/BGC/resources/views/backend/organisation/requestPackage_list.blade.php ENDPATH**/ ?>