        ...
        <div class="col-md-12">               
            <div class="card card-primary card-outline shadow mt-3">
                <div class="car-header p-3">
                    <div class="card-title font-weight-bold text-center"> Users List </div>
                    <div class="float-right">  
                        <a class="btn btn-sm btn-primary" href="<?php echo e(Route('addOrgUserForRoleView')); ?>"><i class="fa fa-plus"></i> Add </a>
                    </div> 
                </div>
                ...
                <div class="card-body">
                    ...
                    <table id="userlist" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php if(isset($data['orgUsers']) && $data['orgUsers'] != "" ): ?>
                                <?php $__currentLoopData = $data['orgUsers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                              
                                <?php if($details['role_id'] != 2 ): ?> 
                                    <tr>
                                        ...
                                        <td><?php echo e($details['role_name']); ?></td>  
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-">
                                                        <a class="btn btn-primary btn-xs " title="<?php echo 'Update' ?>" href="<?php echo e(Route('updateOrgUser',['id'=>$details['id'],'type' => 'edit'])); ?>"><i class="fa fa-edit"></i></a>
                                                    </div>                                                    
...
<?php echo $__env->make('backend.layout.org_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /app/app1/html/BGC/resources/views/backend/organisation/organisation_users_list.blade.php ENDPATH**/ ?>